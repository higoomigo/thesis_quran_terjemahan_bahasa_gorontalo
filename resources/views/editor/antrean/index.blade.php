        ...
        <div class="flex justify-between items-end flex-wrap gap-4">
            <div>
                <div class="flex items-center gap-2 mb-2">
                    <h2 class="text-4xl font-bold text-emerald-800">Antrean Publikasi</h2>
                    <span class="material-symbols-outlined text-4xl text-emerald-500" style="font-variation-settings: 'FILL' 1;">
                        pending_actions
                    </span>
                </div>
                <p class="text-gray-600">Usulan yang telah divalidasi tim pakar dan siap dipublikasikan ke sistem.</p>
            </div>
        </div>
    </header>
